...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss', type=str.lower, default='mse', help='List of loss functions: MSE/L1/MOD/ATAN.')
    ...
    parser.add_argument('--lr_scheduler', action='store_true', default=False, help='Use lr_scheduler for training.')
